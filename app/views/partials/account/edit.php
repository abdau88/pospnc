                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-id_karyawan"  value="<?php  echo $data['id_karyawan']; ?>" type="number" placeholder="Enter Id Karyawan" step="1"  required="" name="id_karyawan"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
