...
class Tb_masterposController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		$db->where("tb_masterpos.nama_pengusul", get_active_user('username') );
		if($fieldname){
		...
		$page_title = $this->view->page_title = "Usulan POS";
	...
	function view($rec_id = null, $value = null){
		...
		if($record){
			$page_title = $this->view->page_title = "Data Usulan POS";
		}
		else{
			if($db->getLastError()){
				$this->set_page_error();
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("nama_pengusul","kd_unit","nama_pos","dasar_hukum","keterkaitan","kualifikasi_pelaksana","peralatan","flowmap");
			...
			if($this->validated()){
				...
				if($rec_id){
					$this->set_flash_msg("Data telah disimpan", "success");
		...
		$page_title = $this->view->page_title = "Tambah Usulan Pos";
