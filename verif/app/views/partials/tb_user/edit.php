                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <select required="" data-endpoint="<?php print_link('api/json/tb_user_id_karyawan_option_list') ?>" id="ctrl-id_karyawan" name="id_karyawan"  placeholder="Ketik Nama Anda ..."    class="selectize-ajax" >
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-nohp"  value="<?php  echo $data['nohp']; ?>" type="text" placeholder="Enter Nohp"  required="" name="nohp"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
