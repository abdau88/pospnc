...
<section class="page ajax-page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Verifikasi POS</h4>
                </div>
                <div class="col-sm-3 ">
                </div>
                <div class="col-sm-4 ">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-primary text-white">
                                            <tr>
                                                ...
                                                <th class="td-sno">#</th>
                                                <th  <?php echo (get_value('orderby')=='nama_pengusul' ? 'class="sortedby td-nama_pengusul"' : null); ?>>
                                                    <?php Html :: get_field_order_link('nama_pengusul', "Nama Pengusul"); ?>
                                                </th>
                                                <th  class="td-kd_unit"> Unit Kerja</th>
                                                <th  class="td-nama_pos"> Nama Pos</th>
                                                <th  class="td-flowmap"> Flowmap</th>
                                                <th  class="td-verifikasi"> Verifikasi</th>
                                                <th  class="td-c_rev"> Catatan Revisi</th>
                                                <th class="td-btn"></th>
                                            </tr>
                                        </thead>
                                        <?php
