...
<section class="page ajax-page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Cetak Pos</h4>
                </div>
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('v_pos'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('v_pos'); ?>">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-tgl_pembuatan"> Tgl Pembuatan</th>
                                                <th  class="td-tgl_revisi"> Tgl Revisi</th>
                                                <th  class="td-tgl_efektif"> Tgl Efektif</th>
                                                <th  class="td-disahkan"> Disahkan</th>
                                                <th  class="td-nama_pos"> Nama Pos</th>
                                                <th  class="td-dasar_hukum"> Dasar Hukum</th>
                                                <th  class="td-kualifikasi_pelaksana"> Kualifikasi Pelaksana</th>
                                                <th  class="td-keterkaitan"> Keterkaitan</th>
                                                <th  class="td-peralatan"> Peralatan</th>
                                            </tr>
                                        </thead>
                                        <?php
                                        if(!empty($records)){
