                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <select required="" data-endpoint="<?php print_link('api/json/account_id_karyawan_option_list') ?>" id="ctrl-id_karyawan" name="id_karyawan"  placeholder="Ketik Nama Anda ..."    class="selectize-ajax" >
